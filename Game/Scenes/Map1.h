...
public:
	Map1() : Scene("Map1Scene")
	{
		...
		GameObject* coral2 = CreateCollectableGameObject("Coral2", Maths::Vector2f(32 * 54.f, 32 * 29.f), "coral", 25.f, "Coral", 10.f);
		GameObject* coral3 = CreateCollectableGameObject("Coral3", Maths::Vector2f(32 * 50.f, 32 * 6.f), "coral", 25.f, "Coral", 40.f);

		GameObject* ore = CreateCollectableGameObject("Ore", Maths::Vector2f(32 * 20.f, 32 * 12.f), "ore", 40.f, "Ore", 10.f);
		GameObject* ore2 = CreateCollectableGameObject("Ore2", Maths::Vector2f(32 * 26.f, 32 * 26.f), "ore", 25.f, "Ore", 20.f);
